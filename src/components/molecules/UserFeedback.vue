  ...
  <li class="review">
    <h5 class="d-flex justify-content-between align-items-center m-0">
      ...
      <figure class="d-flex m-0">
        <img
          v-for="yellowStar in getRoundRaiting.yellowStars"
          src="/src/assets/svg/icon-rating-star-yellow.svg"
          alt=""
        />
        <img
          v-for="blueStar in getRoundRaiting.blueStar"
          src="/src/assets/svg/icon-rating-star-blue.svg"
          alt=""
        />
      </figure>
    </h5>
